...
describe('MedicalCardEntity', () => {
    ...
    it(`/should find user medicalCard/`, async () => {
        ...
        expect(await service.findUserMedicalCard(1)).toStrictEqual(undefined);
    });
    ...
    it(`/should find employee medicalCard/`, async () => {
        ...
        expect(await service.findAll()).toBe(medicalCard);
    });
    ...
    it(`/should find all medicalCard/`, async () => {
        ...
        expect(await service.findAll()).toStrictEqual(medicalCard);
    });
    ...
    it(`/should update medicalCard/`, async () => {
        ...
        expect(await service.update(1, medicalCard)).toStrictEqual(medicalCard);
    });
    ...
    it(`/should create medicalCard/`, async () => {
        ...
        expect(await service.create(medicalCard)).toStrictEqual(medicalCard);
    });
    ...
    it('should find by id = 1', async () => {
        ...
        expect(await service.findById(1)).toStrictEqual(medicalCard);
    });
